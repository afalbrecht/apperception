...
/* package solve-0.2.0.0 */
#ifndef VERSION_solve
#define VERSION_solve "0.2.0.0"
#endif /* VERSION_solve */
#ifndef MIN_VERSION_solve
#define MIN_VERSION_solve(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_solve */
...
#define CURRENT_COMPONENT_ID "solve-0.2.0.0-inplace-solve"
